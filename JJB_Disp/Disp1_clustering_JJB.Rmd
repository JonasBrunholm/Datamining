...
The true data looks like this:

```{r}

plot(Dat_Standardized[,1:2], pch = Dat_Compare_Standardized$Species + 1, col = Dat_Compare_Standardized$Species + 1, main = "true")
plot(Dat_Standardized[,3:4], pch = Dat_Compare_Standardized$Species + 1, col = Dat_Compare_Standardized$Species + 1, main = "true")
```

We can try kmeans on this, like so

```{r}
par(mfrow=c(2,2))
par(mar=c(4,4,2,1))
kmeans_12 <- kmeans(Dat_Standardized[,1:2], centers = 3,nstart = 50)
kmeans_34 <- kmeans(Dat_Standardized[,3:4], centers = 3,nstart = 50)

plot(Dat_Standardized[,1:2], pch = Dat_Compare_Standardized$Species + 1, col = Dat_Compare_Standardized$Species + 1, main = "true")
plot(Dat_Standardized[,3:4], pch = Dat_Compare_Standardized$Species + 1, col = Dat_Compare_Standardized$Species + 1, main = "true")
plot(Dat_Standardized[,1:2], pch = kmeans_12$cluster + 1, col = kmeans_12$cluster + 1, main = "Kmeans")
plot(Dat_Standardized[,3:4], pch = kmeans_34$cluster + 1, col = kmeans_34$cluster + 1, main = "Kmeans")
```
